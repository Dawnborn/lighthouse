...
flags.DEFINE_string(
    "data_dir", default="../testset/test_set_with_coords_fixed/", help="InteriorNet test dataset directory")
flags.DEFINE_string(
    "output_dir", default="./output/", help="Output directory to save images")
