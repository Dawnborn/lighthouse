...
# ******************************************************************************
# The VGG code below is copied from:
...
def build_vgg19(input_tensor, vgg_layers):
  """Construct graph for VGG network."""
  ...
  net['conv1_1'] = build_net(
      'conv', net['input'], get_weight_bias(vgg_layers, 0), name='vgg_conv1_1')
  ...
  net['conv3_1'] = build_net(
      'conv', net['pool2'], get_weight_bias(vgg_layers, 10), name='vgg_conv3_1')
  ...
  net['conv4_1'] = build_net(
      'conv', net['pool3'], get_weight_bias(vgg_layers, 19), name='vgg_conv4_1')
  ...
  net['conv5_1'] = build_net(
      'conv', net['pool4'], get_weight_bias(vgg_layers, 28), name='vgg_conv5_1')
